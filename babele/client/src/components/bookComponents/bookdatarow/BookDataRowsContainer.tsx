...
const PaginationList = styled.div`
  ...
  input {
    ...
    background-image: radial-gradient(circle, rgba(63,94,251,1) 0%, rgba(48,179,235,1) 31%, rgba(38,196,224,0.5200674019607843) 67%, rgba(29,170,213,0.7161458333333333) 100%);
